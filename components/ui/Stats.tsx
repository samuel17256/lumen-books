import { Book, CupSoda, Users } from "lucide-react";
            ...
            <div className="flex flex-col md:flex-row justify-around items-center gap-8 mt-12 space-y-6 md:space-y-0">
                ...
                <div className="flex items-center gap-4 min-w-50">
                    ...
                    <div className="flex flex-col">
                        <span className="font-bold text-4xl text-gray-900">67+</span>
                        <span className="text-sm text-gray-500 font-medium">Published Chapters</span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4 min-w-50">
                    ...
                    <div className="flex flex-col">
                        <span className="font-bold text-4xl text-gray-900">60+</span>
                ...
                <div className="flex items-center gap-4 min-w-50">
                    ...
                    <div className="flex flex-col">
                        <span className="font-bold text-4xl text-gray-900">120+</span>
